...
PU-3 & Platform Usability & Support application development and deployment lifecycle automatically & Partially & A first version of the runtime is included in v2.0 \\ \hline
...
SEC-6 &  Privacy and Security & Comprehensive explanations of security and privacy issues & ? & \\ \hline
GOV-1 & Governance & Platform should support the collection of data related to governance & Partially & Provenance service integrated\\ \hline
...
\caption{v.2.0 of the platform against requirements}
\label{tab:req}
\end{sidewaystable}
