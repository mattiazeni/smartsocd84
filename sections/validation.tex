...
PP-1 & Peer Profiles and Peer Profiling & Peers will be characterized by a static and a dynamic profile. & Yes & The CM maintains the dynamic part of the profile\\ \hline
PP-2 & Peer Profiles and Peer Profiling & Peer profiles data storage & Yes & See \cite{D4.3}  for integration with PPL\\ \hline
PP-3 & Peer Profiles and Peer Profiling & Peers can have multiple profiles & Yes & See \cite{D4.2,D4.3}\\ \hline
PP-4 &Peer Profiles and Peer Profiling  & Platform will support the profiling of peers & Yes & Integration with reputation service completed\\ \hline
PU-1 & Platform Usability & The SmartSociety platform should be accessible through a set of open APIs & Yes & See previous sections of this document \\ \hline
PU-2 & Platform Usability & Ease for developers to create and manage applications & Partially & Using PF interfaces\\ \hline
PU-3 & Platform Usability & Support application development and deployment life-cycle automatically & Partially & Limited support for deployment \\ \hline
...
HT-2 & Platform Components and Interactions Heterogeneity & Platform components will run on a variety of heterogeneous devices & No & Runs only on servers.\\ \hline
